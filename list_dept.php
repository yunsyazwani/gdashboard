...
<html>
  ...
  <body>
    ...
    <div class="little-container">
      <div class="col-md-8">
        <p>DEPARTMENT: <span><?php echo $staffdept;  ?></span></p>
      </div>
          ...
          <table id="dataTables-dept" class="table table-striped table-bordered" style="width:100%">
            <thead class="thead-bg">
              <tr align='center'>
                ...
                <th width="3%">Total Leave Taken</th>
                <th width="8%">Total Evaluation Mark</th>
                <th width=""></th>
                
            </thead>
            <tbody>
            <?php 
            $sql= "SELECT staffid, staffname, staff_jdate, staffpos, staffstatus
            FROM staff  
            WHERE staffdept= '$staffdept'
            ...
            while($row = mysqli_fetch_assoc($result)) { ?>
              ...
              <tr>
                ...
                <td>
                  <span class='text'><a href="list_job.php?staffpos=<?php echo $row['staffpos'] ?>&year=<?php echo $getYear ?>  "><?php echo $row['staffpos'];  ?></a></span>
                </td>
...
<script type="text/javascript">
  $('#yearSelect').change(function(){
    window.location.replace('list_dept.php?staffdept=<?php echo $staffdept; ?>&year='+$(this).val());
